...
MACRO(INIT_BUILD_FLAGS)
  ...
  SET(MULTIARCH $ENV{DEB_HOST_MULTIARCH})

  # Fix library paths suffixes for Debian MultiArch
  IF(MULTIARCH)
    SET(CMAKE_C_LANGUAGE_ARCHITECTURE ${MULTIARCH})
    SET(CMAKE_CXX_LANGUAGE_ARCHITECTURE ${MULTIARCH})
    SET(CMAKE_LIBRARY_ARCHITECTURE ${MULTIARCH})
    SET(CMAKE_C_LIBRARY_ARCHITECTURE ${MULTIARCH})
    SET(CMAKE_CXX_LIBRARY_ARCHITECTURE ${MULTIARCH})
  ENDIF(MULTIARCH)
