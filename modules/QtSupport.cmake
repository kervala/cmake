...
MACRO(USE_QT_MODULES)
  ...
  # Qt 5 modules
  SET(QT5_MODULES ${QT_SHARED_MODULES} Bluetooth Concurrent LinguistTools MultimediaQuick MultimediaWidgets Nfc OpenGL OpenGLExtensions PlatformSupport Positioning PrintSupport Quick QuickParticles QuickTest QuickWidgets Sensors SerialPort V8 WebChannel WebKitWidgets WebSockets Widgets WinExtras)
...
MACRO(LINK_QT_LIBRARIES _TARGET)
  IF(QT)
    IF(QT5)
      IF("${Qt5Core_VERSION_STRING}" VERSION_LESS "5.3")
