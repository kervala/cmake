        ...
        FOREACH(_MODULE ${QT_MODULES_USED})
          IF(_MODULE STREQUAL Core)
            ...
            ELSEIF(APPLE)
              ...
              TARGET_LINK_LIBRARIES(${TARGET} ${PCRE_LIBRARY} ${FOUNDATION_FRAMEWORK} ${COCOA_FRAMEWORK} ${CARBON_FRAMEWORK} ${SYSTEMCONFIGURATION_FRAMEWORK} ${SECURITY_FRAMEWORK} ${IOKIT_FRAMEWORK})
