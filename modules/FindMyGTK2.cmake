...
foreach(_GTK2_component ${MyGTK2_FIND_COMPONENTS})
    if(_GTK2_component STREQUAL "gtk")
        ...
        _GTK2_FIND_INCLUDE_DIR(LIBXML2 libxml/xpath.h)
        _GTK2_FIND_LIBRARY    (LIBXML2 xml2 false false)

        IF(WIN32)
            _GTK2_FIND_LIBRARY    (INTL intl false false)
            _GTK2_FIND_LIBRARY    (GTHREAD gthread false true)
        ELSEIF(APPLE)
            _GTK2_FIND_LIBRARY    (INTL intl false false)
        ELSE()
            _GTK2_FIND_INCLUDE_DIR(GNOMEVFS libgnomevfs/gnome-vfs.h)
        ENDIF()
    ...
    elseif(_GTK2_component STREQUAL "gtkmm")
        ...
        _GTK2_FIND_INCLUDE_DIR(LIBXML++ libxml++/libxml++.h)
        _GTK2_FIND_INCLUDE_DIR(LIBXML++CONFIG libxml++config.h)
        _GTK2_FIND_LIBRARY    (LIBXML++ xml++ true true)

        # External not GTK2 related
        IF(UNIX AND NOT APPLE)
            _GTK2_FIND_INCLUDE_DIR(GNOMEVFSMM libgnomevfsmm.h)
            _GTK2_FIND_LIBRARY    (GNOMEVFSMM gnomevfsmm true true)
