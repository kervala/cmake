...
IF(TARGET_X64)
    SET(GTKMM_BASEPATH $ENV{GTKMM64_BASEPATH})
ELSE(TARGET_X64)
    SET(GTKMM_BASEPATH $ENV{GTKMM_BASEPATH})
ENDIF(TARGET_X64)
...
function(_GTK2_FIND_LIBRARY _var _lib _expand_vc _append_version)
    ...
    if(_append_version)
        ...
        set(_lib_list ${_library} lib${_library})
        set(_libd_list ${_library_d} lib${_library_d})
    endif()
...
if(NOT MyGTK2_FIND_COMPONENTS)
    # Assume they only want GTK
    set(MyGTK2_FIND_COMPONENTS gtk)
endif()
...
foreach(_GTK2_component ${MyGTK2_FIND_COMPONENTS})
    if(_GTK2_component STREQUAL "gtk")
        ...
        # External not GTK2 related
        _GTK2_FIND_INCLUDE_DIR(GTK2_LIBXML2_INCLUDE_DIR libxml/xpath.h)

        IF(WIN32)
            _GTK2_FIND_LIBRARY    (GTK2_LIBXML2_LIBRARY xml2 false false)
            _GTK2_FIND_LIBRARY    (GTK2_INTL_LIBRARY intl false false)
        ...
        ELSE(WIN32)
            IF(APPLE)
                ...
                _GTK2_FIND_LIBRARY    (GTK2_INTL_LIBRARY intl false false)
            ELSE(APPLE)
                _GTK2_FIND_INCLUDE_DIR(GTK2_GNOMEVFS_INCLUDE_DIR libgnomevfs/gnome-vfs.h)
            ENDIF(APPLE)
        ENDIF(WIN32)
    ...
    elseif(_GTK2_component STREQUAL "gtkmm")
        ...
        _GTK2_FIND_INCLUDE_DIR(GTK2_LIBXML++_INCLUDE_DIR libxml++/libxml++.h)
        _GTK2_FIND_INCLUDE_DIR(GTK2_LIBXML++CONFIG_INCLUDE_DIR libxml++config.h)
        _GTK2_FIND_LIBRARY    (GTK2_LIBXML++_LIBRARY xml++ true true)

        # External not GTK2 related
        IF(UNIX AND NOT APPLE)
            _GTK2_FIND_INCLUDE_DIR(GTK2_GNOMEVFSMM_INCLUDE_DIR libgnomevfsmm.h)
            _GTK2_FIND_LIBRARY    (GTK2_GNOMEVFSMM_LIBRARY gnomevfsmm true true)
