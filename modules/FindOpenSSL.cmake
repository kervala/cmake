...
FIX_PACKAGE_OPTIONS(OpenSSL Crypto)
FIND_PACKAGE_HELPER(Crypto openssl/ssl.h RELEASE libeay32 DEBUG libeay32d DIR ${OPENSSL_DIR} QUIET)

FIX_PACKAGE_OPTIONS(OpenSSL SSL)
FIND_PACKAGE_HELPER(SSL openssl/ssl.h RELEASE ssleay32 DEBUG ssleay32d DIR ${OPENSSL_DIR} QUIET)
...
IF(CRYPTO_FOUND AND SSL_FOUND)
  ...
  IF(WITH_STATIC_EXTERNAL)
    FIND_PACKAGE(MyZLIB)
    LIST(APPEND OPENSSL_LIBRARIES ${ZLIB_LIBRARIES} ${CMAKE_DL_LIBS})
  ENDIF()
