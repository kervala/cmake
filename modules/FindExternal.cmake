...
IF(EXTERNAL_PATH)
  ...
  FOREACH(ITEM ${EXTERNAL_PATH})
    ...
    IF(TARGET_X64)
      SET(EXTERNAL_BINARY_PATH ${EXTERNAL_BINARY_PATH} "${ITEM}/bin64")
    ELSE(TARGET_X64)
      SET(EXTERNAL_BINARY_PATH ${EXTERNAL_BINARY_PATH} "${ITEM}/bin")
    ENDIF(TARGET_X64)

    # Using 32 or 64 bits libraries
    IF(TARGET_X64)
      SET(EXTERNAL_LIBRARY_PATH ${EXTERNAL_LIBRARY_PATH} "${ITEM}/lib64")
    ELSE(TARGET_X64)
      SET(EXTERNAL_LIBRARY_PATH ${EXTERNAL_LIBRARY_PATH} "${ITEM}/lib")
    ENDIF(TARGET_X64)
  ENDFOREACH(ITEM)
